...
#check String → (String → String)   -- #2 takes a string then sliently returns a function that takes a string and returns a string as final result 
#check String → String → String     -- #3 or takes two string args then returns an arg 

#eval String.append "Hello" " Lean"
#eval (String.append "Hello") " Lean"

def funny := (String.append "Hello ")
#eval funny "Boo"
...
- Ans: #! Accepts a function (the returns a string) and a string as arguments to then output a strnig
- Give some examples of functions of these types
`-/

def bunny : (String → String) → String
| f => "Hi!"
...
can check by typing "#check crazy"
`-/
...
def crazy3 (f : String → String) (a : String) : String := (f a)
def crazy4 : (String → String) → String → String
| g, h → (g h) 
#check crazy4
def crazy5 (a : String → String) (b : String) : String := (a b)
#check crazy5
...
#eval crazy2 f1 s2
#check crazy   
def crazy8 : (String → String) → String → String
| d, f → (d f)
def crazy9 (r : String → String) (n : String) : String := (r n)
#check crazy9
...
| true, true => true -- fill in the four cases
| true, false => false
| false, true => false
| false, false => true 
...
--             b1   b2    (!b1 && !b2)
#eval mystery false false -- true
#eval mystery true true -- false
#eval mystery false true -- false
