...
| n => n -- if String n is called, then ouput n
...
-- Below is equilvant version of lines 71-72
def id_poly'' (α : Type) : α → α 
| v => v
...
#eval id_poly String "Hey" -- you can't have Type as an argument


 Test of Knowledge 
 

/-! What is the Type of id_poly String? Write a line to check your answer-/ 
-- Ans: String → String
#check (id_poly String)
...
-- id_poly takes a Type (Bool) and value of that type (true)
#check id_poly Nat 7
#check id_poly String "Hello"

/-!
## Implicit Arguments
-- some arguments that Lean should be able ot infer
...
-- Can't put implicit arguments explicitly, ex: lines 198-200
...
Test of knowledge
/-! Can you take out the paratheis and it still equals the same?
NO! - It is left associative with parathesis on, w/o them then the
function turns into right associative. it would try to apply f to f -/
/-!
...
#eval apply2_nat square 2     -- expect 16 ((2 * 2) * (2 * 2))
#eval apply2_nat square 3     -- expect 81 ((3 * 3) * (3 * 3))

-- #eval square (square 2) = #eval apply2_nat square 2 
